...
object Exercises {
  ...
  // makes us believe slightly more that an odd number of balls are in the urn.
  ...
  // Now  define  the  posterior   probabilities  for  all  odd  sizes of  the
  // urn  from  1   to  UpperBound. You  can  do  this  using
  // Importance.probability.  We need a  slightly different version of it that
  // takes a predicate, not a concrete value:
  //
